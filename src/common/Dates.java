...
public class Dates {
	...
	public static Date fromString(String string) {
		...
		return Dates.fromDdMmYyyy(Integer.parseInt(dateString[0]), Integer.parseInt(dateString[1]),
				Integer.parseInt(dateString[2]));
	}
	
	public static Date fromStringDueDate(String string) {
		String dateString[] = string.split("/");
		if (dateString.length != 2) {
			throw new NumberFormatException("Invalid fields for date");
		}
		return Dates.fromMmYY(Integer.parseInt(dateString[0]), Integer.parseInt(dateString[1]));
	}

	private static Date fromMmYY(int mm, int yyyy) {
	...
	public static String toStringDueDate(Date date) {
