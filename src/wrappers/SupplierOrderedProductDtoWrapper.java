 ...
 *
 */
public class SupplierOrderedProductDtoWrapper implements DtoWrapper {
	 ...
	 */
	public SupplierOrderedProductDtoWrapper(ProductDto dto) {
		this.dto = dto;
	}
	...
	public Object[] getHeaders() {
		...
		String header5 = conf.getProperty("UNITS");
		return new Object[] { header1, header2, header3, header4, header5 };
